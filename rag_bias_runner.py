# RAG Bias Analysis Runner with Claude API
...
if __name__ == "__main__":
    ...
    analyzer = ClaudeRAGAnalyzer(API_KEY)

    # Run a sample analysis
    from rag_bias_analysis import RAGBiasAnalyzer, TEST_PROFILES, TEST_QUERIES, SYSTEM_PROMPT

    rag_analyzer = RAGBiasAnalyzer(SYSTEM_PROMPT)
    test_cases = rag_analyzer.run_full_analysis()[:10]  # Run first 10 analysis cases

    # Execute analysis
    results_df = analyzer.run_bias_analysis(test_cases)
